package io.github.orionlibs.spring_http_request_logger.config;

import static org.junit.jupiter.api.Assertions.assertEquals;

import io.github.orionlibs.spring_http_request_logger.utils.FakeSpringEnvironment;
import io.github.orionlibs.spring_http_request_logger.configuration.FakeTestingSpringConfiguration.FakeConfiguration;
...
public class OrionConfigurationTest
{
    ...
    void test_loadDefaultAndCustomConfiguration_customConfigurationOverridesDefault() throws Exception
    {
        ...
        assertEquals("SEVERE", configuration.getProperty("io.github.orionlibs.spring_http_request_logger.level"));
    }
    ...
    void test_loadDefaultAndCustomConfiguration_noCustomConfigurationOverridesDefault() throws Exception
    {
        ...
        configuration.loadDefaultAndCustomConfiguration(configStream, env);
        assertEquals("INFO", configuration.getProperty("io.github.orionlibs.spring_http_request_logger.level"));
    }
    ...
    void test_getAsInputStream() throws Exception
    {
        ...
        assertEquals("INFO", configuration.getProperty("io.github.orionlibs.spring_http_request_logger.level"));
        assertEquals("INFO", configurationCopy.getProperty("io.github.orionlibs.spring_http_request_logger.level"));
    }
    ...
    private void buildFakeSpringEnvironmentWithProperties()
    {
        ...
        properties.put("io.github.orionlibs.spring_http_request_logger.level", "SEVERE");
