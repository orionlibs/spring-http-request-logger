...
import io.github.orionlibs.spring_http_request_logger.LoggingInterceptor;
...
public class OrionConfiguration extends Properties
{
     ...
     */
    public static final String LOGGER_CONFIGURATION_FILE = "/io/github/orionlibs/spring_http_request_logger/configuration/orion-logger.prop";
    /**
     * The location of the configuration file that has configuration for the features of this plugin.
     */
    public static final String FEATURE_CONFIGURATION_FILE = "/io/github/orionlibs/spring_http_request_logger/configuration/feature-configuration.prop";
